...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FlinkLibraryAccessors extends SubDependencyFactory {
        ...
        public FlinkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for clients (org.apache.flink:flink-clients_scala_2.12)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getClients() { return create("flink.clients"); }
    ...
    public static class FlinkStreamingLibraryAccessors extends SubDependencyFactory {
        ...
        public FlinkStreamingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for scala (org.apache.flink:flink-streaming-scala_2.12)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getScala() { return create("flink.streaming.scala"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        public BundleAccessors(ObjectFactory objects, ProviderFactory providers, DefaultVersionCatalog config, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) { super(objects, providers, config, attributesFactory, capabilityNotationParser); }
             ...
             *    <li>org.apache.flink:flink-clients_scala_2.12</li>
             *    <li>org.apache.flink:flink-streaming-scala_2.12</li>
